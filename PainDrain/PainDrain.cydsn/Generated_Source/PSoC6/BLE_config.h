...
#define CY_BLE_CUSTOM_SERVICE_SERVICE_HANDLE   (0x0016u) /* Handle of Custom Service service */
#define CY_BLE_CUSTOM_SERVICE_CUSTOM_CHARACTERISTIC_DECL_HANDLE   (0x0017u) /* Handle of Custom Characteristic characteristic declaration */
#define CY_BLE_CUSTOM_SERVICE_CUSTOM_CHARACTERISTIC_CHAR_HANDLE   (0x0018u) /* Handle of Custom Characteristic characteristic */
