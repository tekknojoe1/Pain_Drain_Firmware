...
module top ;
    ...
    TCPWM_PWM_PDL_v1_0_2 PWM_TENS2 (
        .clock(Net_551),
        .compare(Net_552),
        .count(1'b1),
        .interrupt(Net_554),
    ...
    TCPWM_PWM_PDL_v1_0_10 PWM_PEL2 (
        .clock(Net_591),
        .compare(Net_592),
        .count(1'b1),
        .interrupt(Net_594),
