...
# Date: Thu, 16 May 2024 16:27:57 GMT
#set_units -time ns
...
create_generated_clock -name {Clock_7} -source [get_pins {ClockBlock/periclk}] -edges {1 3 5} -nominal_period 82.5 [list [get_pins {ClockBlock/ff_div_19}]]
