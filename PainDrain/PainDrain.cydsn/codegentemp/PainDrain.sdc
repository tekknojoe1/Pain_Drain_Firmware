...
# Date: Thu, 04 Jan 2024 18:24:29 GMT
#set_units -time ns
create_clock -name {CyClk_LF} -period 30517.578125 -waveform {0 15258.7890625} [list [get_pins {ClockBlock/lfclk}]]
create_clock -name {CyILO} -period 31250 -waveform {0 15625} [list [get_pins {ClockBlock/ilo}]]
create_clock -name {CyClk_HF1} -period 125 -waveform {0 62.5} [list [get_pins {ClockBlock/hfclk_1}]]
...
create_generated_clock -name {Clock_1} -source [get_pins {ClockBlock/periclk}] -edges {1 5 9} [list [get_pins {ClockBlock/ff_div_18}]]
create_generated_clock -name {Clock_7} -source [get_pins {ClockBlock/periclk}] -edges {1 3 5} -nominal_period 81.25 [list [get_pins {ClockBlock/ff_div_19}]]
create_generated_clock -name {Clock_3} -source [get_pins {ClockBlock/periclk}] -edges {1 2 3} [list [get_pins {ClockBlock/ff_div_20}]]
