...
/* ARM CM4 */
    ...
    const cy_stc_sysint_t gpio_irq_cfg = {
        .intrSrc = (IRQn_Type)gpio_irq__INTC_NUMBER,
        .intrPriority = gpio_irq__INTC_CORTEXM4_PRIORITY
    };

    /* WDTIsr */
    const cy_stc_sysint_t WDTIsr_cfg = {
        .intrSrc = (IRQn_Type)WDTIsr__INTC_NUMBER,
