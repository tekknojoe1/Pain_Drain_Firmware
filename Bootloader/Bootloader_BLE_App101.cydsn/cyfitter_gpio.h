...
/* CapsLock_LED */
#define CapsLock_LED_0_DRIVEMODE CY_GPIO_DM_STRONG_IN_OFF
#define CapsLock_LED_0_INBUF_ENABLED 0u
#define CapsLock_LED_0_INIT_DRIVESTATE 1u
#define CapsLock_LED_0_INIT_MUXSEL 0u
#define CapsLock_LED_0_INPUT_SYNC 2u
#define CapsLock_LED_0_INTERRUPT_MODE CY_GPIO_INTR_DISABLE
#define CapsLock_LED_0_NUM 1u
#define CapsLock_LED_0_PORT GPIO_PRT11
#define CapsLock_LED_0_SLEWRATE CY_GPIO_SLEW_FAST
#define CapsLock_LED_0_THRESHOLD_LEVEL CY_GPIO_VTRIP_CMOS
#define CapsLock_LED_DRIVEMODE CY_GPIO_DM_STRONG_IN_OFF
#define CapsLock_LED_INBUF_ENABLED 0u
#define CapsLock_LED_INIT_DRIVESTATE 1u
#define CapsLock_LED_INIT_MUXSEL 0u
#define CapsLock_LED_INPUT_SYNC 2u
#define CapsLock_LED_INTERRUPT_MODE CY_GPIO_INTR_DISABLE
#define CapsLock_LED_NUM 1u
#define CapsLock_LED_PORT GPIO_PRT11
#define CapsLock_LED_SLEWRATE CY_GPIO_SLEW_FAST
#define CapsLock_LED_THRESHOLD_LEVEL CY_GPIO_VTRIP_CMOS
