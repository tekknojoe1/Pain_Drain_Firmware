...
***************************************/
#define CY_BLE_HIDS
#define CY_BLE_HIDS_SERVER
#define CY_BLE_DIS
#define CY_BLE_DIS_SERVER
#define CY_BLE_BAS
#define CY_BLE_BAS_SERVER
#define CY_BLE_SCPS
#define CY_BLE_SCPS_SERVER
#define CY_BLE_IAS
...
#define CY_BLE_ADV_PKT_0_INDEX_SERVICE_UUID_16   (0x11u)
#define CY_BLE_ADV_PKT_0_INDEX_APPEARANCE   (0x1Bu)
...
#define CY_BLE_CONFIG_GATT_DB_MAX_VALUE_LEN         (0x003Fu)
#define CY_BLE_GATT_DB_INDEX_COUNT                  (0x0035u)
...
#define CY_BLE_CONFIG_HIDSS_SERVICE_COUNT           (0x01u)

/** The maximum supported count of HID reports for the GATT Server role. */
#define CY_BLE_CONFIG_HIDSS_REPORT_COUNT            (0x02u)
...
typedef enum
{
    CY_BLE_HUMAN_INTERFACE_DEVICE_SERVICE_INDEX
}cy_en_ble_hidss_indexes_t;

/* Human Interface Device service Report characteristics indexes */
#define CY_BLE_HUMAN_INTERFACE_DEVICE_REPORT_IN   (CY_BLE_HIDS_REPORT) /* Report In characteristic index */
#define CY_BLE_HUMAN_INTERFACE_DEVICE_REPORT_OUT   (CY_BLE_HIDS_REPORT + 1u) /* Report Out characteristic index */
